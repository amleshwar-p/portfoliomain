  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        <div>
          <Link
            href="https://drive.google.com/file/d/1oMNjTekuiNMFOI4ls_rrpk4_yuSVpyFX/view?usp=drive_link"
            target="_blank"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Tech enthusiast with a great intrest in Problem Solving{" "}
