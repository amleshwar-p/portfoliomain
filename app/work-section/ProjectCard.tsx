  ...
  return (
    <motion.div
      style={{
        ...
        position: "relative",
        minHeight: "515px",  // Give a min-height to maintain consistency
      } as React.CSSProperties}
      className={`relative z-10 w-[90%] max-w-[950px] items-stretch justify-center overflow-hidden rounded-3xl bg-center py-0 mx-auto mt-4`}
      initial="initial"
      animate="animate"
    >
      <Image
